...
| 3 | Alternate reading schedules | Support reading plans beyond the Bible Companion (e.g. other Christadelphian or general plans) the user can choose from. | — | L/XL | 🟢 Ready to spec | **Spec:** [features/alternate-reading-schedules.md](features/alternate-reading-schedules.md) (owner moved it off the backlog; supersedes the [exploration](explorations/alternate-reading-schedules.md)). Identity evolution ("THE Bible Companion app" → "a reading-plan app whose flagship is the Bible Companion"). Recommended first cut: **M'Cheyne first** (structurally identical, well-sourced, low-risk), **a named date-anchored chronological plan second** (biggest data lift). Awaiting owner sign-off on the §11 OQs — esp. OQ-3 progress-on-switch (recommended: per-plan), OQ-4 anchoring scope (recommended: date-anchored/365-day only). |
